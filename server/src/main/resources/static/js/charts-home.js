...
$(document).ready(function () {
    ...
    fetch("api/getWorkerNumberHistory")
    .then(res => res.json())
    .then(json => {
        console.log(json);
    ...
    fetch("api/getAverageTaskFinishTime/0")
    .then(res => res.json())
    .then(json => {
        document.getElementById('avg_finish_time').textContent = json['avg'];
